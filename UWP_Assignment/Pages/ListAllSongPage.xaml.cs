...
namespace UWP_Assignment.Pages
{
    ...
    /// </summary>
    public sealed partial class ListAllSongPage : Page
    {
        ...
        public ListAllSongPage()
        {
            ...
            this.Loaded += ListAllSongPage_Loaded;
        }
        ...
        private async void ListAllSongPage_Loaded(object sender, RoutedEventArgs e)
        {
            List<Song> listSong = await songService.GetAllSongAsync();
